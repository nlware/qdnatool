...
<div class="row">
  ...
  <div class="span6">
    ...
    <p><?php echo __('Use the support site %s for tips, tricks, examples and more', $this->Html->link('docs.qdnatool.org', 'http://docs.qdnatool.org/', array('target' => '_blank'))); ?></p>
    <p><?php echo __('Log-in automatically via SURFconext if your institution has licensed the qDNA tool.'); ?></p>
    <p><?php echo __('Read more information about access via SURFconext: %s', $this->Html->link('www.surfconext.nl', 'http://www.surfconext.nl/', array('target' => '_blank'))); ?></p>
  </div>
</div>