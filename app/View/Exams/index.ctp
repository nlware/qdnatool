...
<div class="exams index">
  <?php echo $this->Html->link('<i class="icon-plus icon-white"></i> '.__('Add Exam'), array('action' => 'add'), array('class' => 'btn btn-primary pull-right', 'escape' => false)); ?>	<h4><?php echo __('Exams'); ?></h4>
	<table class="table">
	  <thead>
    	<tr>
