...
<div class="exams index">
	<?php
	echo $this->Html->link(
		'<i class="icon-plus icon-white"></i> ' . __('Add Exam'), array(
			'action' => 'add'
		), array(
			...
			foreach ($exams as $exam):
				...
				<tr>
					...
					<td class="actions">
						...
						if (!empty($exam['Exam']['analysed'])):
							echo $this->Html->link(
								__('Start interpretation'), array(
									'action' => 'stevie', $exam['Exam']['id']
								), array(
									'class' => 'btn'
								)
							);
						elseif (empty($exam['Child'])):
							echo $this->Form->postLink(
								__('Delete'), array(
									...
									'class' => 'btn',
									'confirm' => __('Are you sure you want to delete exam "%s"?', $exam['Exam']['name'])
								)
							);
						endif;
						?>
							...
							<ul class="dropdown-menu">
								...
								<li>
									<?php
									echo $this->Html->link(__('Start interpretation'), array('action' => 'stevie', $exam['Exam']['id']));
									?>
								</li>
								<?php
								endif;
								...
								<li>
									<?php
									echo $this->Html->link(
										__('Download report'), array(
											'action' => 'report', $exam['Exam']['id'], 'ext' => 'pdf'
										)
									);
									?>
								</li>
								<li>
									<?php
									echo $this->Html->link(
										__('Download scores'), array(
											'action' => 'scores', $exam['Exam']['id'], 'ext' => 'csv'
										)
									);
									?>
								</li>
								<li>
									<?php
									echo $this->Html->link(
										__('Download scores (Dutch format)'), array(
											'action' => 'scores', $exam['Exam']['id'], 'nld', 'ext' => 'csv'
										)
									);
									?>
								</li>
								<li>
									<?php
									echo $this->Html->link(
										__('Show missings'), array(
											'action' => 'missings', $exam['Exam']['id']
										)
									);
									?>
								</li>
								...
								<li>
									<?php
									echo $this->Html->link(__('Reanalyse'), array('action' => 'reanalyse', $exam['Exam']['id']));
									?>
								</li>
								<?php
								endif;
				...
				if (!empty($exam['Child'])):
					...
					<tr>
						...
						<td>
							<?php
							$inProgressStates = array(
								ExamState::ANALYSING,
								ExamState::IMPORTING,
								ExamState::WAITING_TO_ANALYSE,
								ExamState::WAITING_TO_IMPORT,
								ExamState::WAITING_TO_GENERATE_REPORT,
								ExamState::GENERATING_REPORT
							);
							if (in_array($child['exam_state_id'], $inProgressStates)):
								$doAutoRefresh = true;
								echo $this->Html->link(
									'<i class="icon-time"></i>',
									'#', array(
						...
						<td class="actions">
							<div class="btn-group">
								...
								if (!empty($child['analysed'])):
									...
									echo $this->Form->postLink(
										__('Delete'), array(
											...
											'class' => 'btn',
											'confirm' => __('Are you sure you want to delete exam "%s"?', $child['name'])
										)
									);
								endif;
								?>
								<button class="btn dropdown-toggle" data-toggle="dropdown">
									...
									<li>
										<?php
										echo $this->Html->link(__('Start interpretation'), array('action' => 'stevie', $child['id']));
										?>
									</li>
									<?php
									endif;
									...
									<li>
										...
										echo $this->Html->link(
											__('Download report'), array(
												'action' => 'report', $child['id'], 'ext' => 'pdf'
											)
										);
										?>
									</li>
									<li>
										...
										echo $this->Html->link(
											__('Download scores'), array(
												'action' => 'scores', $child['id'], 'ext' => 'csv'
											)
										);
										?>
									</li>
									<li>
										...
										echo $this->Html->link(
											__('Download scores (Dutch format)'), array(
												'action' => 'scores', $child['id'], 'nld', 'ext' => 'csv'
											)
										);
										?>
									</li>
