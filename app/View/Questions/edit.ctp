...
<?php echo $this->Form->create('Question'); ?>
  <div class="span9">
	<?php
      ...
      { $.ajax
        ({  async:false,
          data:$("#QuestionEditForm").find("input, select[class~=analyse], textarea[class~=analyse]").serialize(), 
    			dataType:"html", 
      ...
      { $.ajax
        ({  async:false,
          data:$("#QuestionEditForm").find("select[class~=show_help]").serialize(), 
          dataType:"html", 
          success:function (data, textStatus) 
          { $("#tabHelp").html(data);
  ...
  ?>
    ...
    <h4><?php echo h($this->Form->value('Question.name')); ?></h4>
   	<div class="row">
   	  <div class="span6">
   	    <div class="row">
   	      <div class="span3">
    ...
    <?php 
      ...
      <div class="span3">  
            ...
            <tr>
      		    ...
      		    <?php
        		    ...
        		    ( '<i class="icon-plus"></i> ' . __('Add Tag'),
        		      '#', array
        		      ( 'onclick' => '
        		          typeahead=$(\'tr:hidden input.typeahead:first\');
        ...
        <?php
          echo $this->Form->input('comment', array('label' => __('Comments'), 'rows' => 10));
        ?>
      </div>
    </div>
